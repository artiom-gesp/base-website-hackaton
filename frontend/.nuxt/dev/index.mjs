import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getCookie, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText, H3Error } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import fs, { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/defu/dist/defu.mjs';
import { html as html$2 } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/image-size/dist/index.js';
import { consola, createConsola } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/consola/dist/index.mjs';
import { createGenerator } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@unocss/preset-wind/dist/index.mjs';
import { Launcher } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/playwright-core/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse as parse$1, uneval } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@unhead/shared/dist/index.mjs';
import { createHooks } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/errx/dist/index.js';
import devalue from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { hash } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/ohash/dist/index.mjs';
import { extname, isAbsolute } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/slugify/slugify.js';
import remarkParse from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/rehype-raw/index.js';
import { detab } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/detab/index.js';
import { toString } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/github-slugger/index.js';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/ipx/dist/index.mjs';
import lruCacheDriver from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import { Resvg } from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/satori/dist/index.js';
...
const rootDir = "/Users/artiomgesp/Documents/hackation/website/frontend";

const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/de-DE-sitemap.xml": {
        "redirect": {
          "to": "/__sitemap__/de-DE.xml",
          "statusCode": 307
        }
      },
      "/__sitemap__/en-EN.xml": {},
      "/en-EN-sitemap.xml": {
        "redirect": {
          "to": "/__sitemap__/en-EN.xml",
          "statusCode": 307
        }
      },
      "/_nuxt/builds/meta/**": {
  ...
  "nuxt-og-image": {
    ...
    "resvgOptions": {},
    "sharpOptions": {},
    "publicStoragePath": "root:src:public",
    "defaults": {
      "emojis": "noto",
      "renderer": "satori",
      "component": "NuxtSeo",
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/artiomgesp/Documents/hackation/website/frontend/src/public"
      ]
    },
    "http": {
      "domains": [
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/artiomgesp/Documents/hackation/website/frontend/.nuxt/cache/nuxt-og-image@3.0.8/_fonts"},{"baseName":"server","dir":"/Users/artiomgesp/Documents/hackation/website/frontend/src/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/artiomgesp/Documents/hackation/website/frontend/src/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/artiomgesp/Documents/hackation/website/frontend/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/artiomgesp/Documents/hackation/website/frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/artiomgesp/Documents/hackation/website/frontend/src/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/artiomgesp/Documents/hackation/website/frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/artiomgesp/Documents/hackation/website/frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/artiomgesp/Documents/hackation/website/frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _vE2yFFw58r = defineNitroPlugin(async (nitroApp) => {
...
const _zUsFtmz1lq = defineNitroPlugin(async (nitroApp) => {
...
const _25OoLcBtgN = defineNitroPlugin((nitroApp) => {
...
const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"Sqc3OTP2KQ","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"i7kLnGApLD","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"q432NYEB0T","pascalName":"Pergel","kebabName":"pergel","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"6bQOH7FKu2","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/artiomgesp/Documents/hackation/website/frontend/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _BnqzVcJ5Nx = defineNitroPlugin((nitroApp) => {
...
const _aJa5Fgi11R = defineNitroPlugin(async (nitro) => {
  return;
});

const _HFkNJMs9VF = defineNitroPlugin(async (nitro) => {
...
const _4gvWHc = defineEventHandler(async (e) => {
...
const _4Bc6tX = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _5PDLZx = defineEventHandler(async (e) => {
...
const _cHmvKq = defineEventHandler(async (e) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _v6Lo2R = defineEventHandler(async (e) => {
  const content = [];
  try {
...
const _32StIf = defineEventHandler(async (e) => {
...
const _KO2CBz = defineEventHandler(async (e) => {
...
const _UpOwVz = defineEventHandler(async (e) => {
...
const _Z2Qev6 = defineEventHandler(async (e) => {
...
const _7Rv0IL = defineEventHandler(async (e) => {
...
const _Espf8l = defineEventHandler(async (e) => {
...
const _oo3QQj = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
  if (fileMapping[path]) {
...
const _ZWOuvD = defineEventHandler(async (event) => {
...
const _8QwLWR = defineEventHandler(async (event) => {
...
const _MqShF1 = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _QRqvgQ = lazyEventHandler(() => {
...
const _lazy_fNSbvu = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_1wTWRv = () => Promise.resolve().then(function () { return sitemap_index_xml$1; });
const _lazy_me1hZb = () => Promise.resolve().then(function () { return _sitemap__xml$1; });
const _lazy_puEOiQ = () => Promise.resolve().then(function () { return font$1; });
const _lazy_UMj4QK = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_tQyu5z = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_fNSbvu, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _4gvWHc, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _4Bc6tX, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _5PDLZx, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cHmvKq, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/nuxt-content.json', handler: _v6Lo2R, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _32StIf, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _KO2CBz, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _UpOwVz, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap_index.xml', handler: _lazy_1wTWRv, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/**:sitemap', handler: _lazy_me1hZb, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _Z2Qev6, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _7Rv0IL, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Espf8l, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_puEOiQ, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_UMj4QK, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_tQyu5z, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_tQyu5z, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _oo3QQj, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _ZWOuvD, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _ZWOuvD, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _ZWOuvD, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _8QwLWR, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _MqShF1, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _MqShF1, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _MqShF1, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _QRqvgQ, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fNSbvu, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///Users/artiomgesp/Documents/hackation/website/frontend/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const sources$1 = [
    ...
    },
    {
        ...
        "urls": [
            ...
            {
                "loc": "/de-DE-sitemap.xml",
                "_sitemap": "en-EN"
            },
            {
                "loc": "/en-EN-sitemap.xml",
                "_sitemap": "en-EN"
            }
        ],
        "sourceType": "app"
...
const getClientManifest = () => import('file:///Users/artiomgesp/Documents/hackation/website/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/artiomgesp/Documents/hackation/website/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
