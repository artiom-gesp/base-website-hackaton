...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../src/plugins/components.js")> &
  InjectionType<typeof import("../nuxt-booster/plugin.server.js")> &
  InjectionType<typeof import("../nuxt-booster/plugin.client.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin' | 'nuxt-seo:fallback-titles' | 'nuxt-seo:defaults' | 'nuxt-site-config:i18n' | 'nuxt:checkIfLayoutUsed' | 'booster-plugin' | 'booster-plugin'
  }
}
